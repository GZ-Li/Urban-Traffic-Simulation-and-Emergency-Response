...
# 3. 指标配置（添加完整名称和单位）
metrics = [
    # {"name": "Lane Congestion", "short": "lane_cong", "unit": "%", "direction": "small"},
    ...
    # {"name": "Junction Queue", "short": "junc_queue", "unit": "veh", "direction": "small"},
    # {"name": "Junction Speed", "short": "junc_speed", "unit": "m/s", "direction": "large"}
]
...
improvement_data["three_lanes"][2] = 14.7
improvement_data["two_lanes"][2] = 11.3
