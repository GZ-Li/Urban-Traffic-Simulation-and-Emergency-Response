...
accuracy, df_ = calculate_acc(mapping_dict, road_df, normal_dict['16000'], rain_dict['1.5_2.0_20_4.0']['16000'])
...
# arcmap_df.to_csv('predict_diff_0718_scale_2.csv', encoding='utf-8', index=False) 