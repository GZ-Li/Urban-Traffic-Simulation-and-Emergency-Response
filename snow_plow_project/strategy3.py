...
def get_score(cleared_distance, uncleared_distance, length, num_lane, traffic_flow, alpha1 = 10000000, v1 = 2, v2 = 1): # score = traffic_flow / (alpha1 * (length * num_lane) + alpha2 * (cleared_distance / v1 + uncleared_distance / v2))
