...
# ==================== 配置部分 ====================
simulation_config = {
    "sumo_cfg": "Core_500m_test_rain.sumocfg",
    "original_route": "rou\\mapcore_500m_core_withshape_with_light_test.rou.xml",
    "rain_route": "rou\\mapcore_500m_core_withshape_with_light_test_rain.rou.xml",
    "net_path": "net\\core_withshape_with_light_changing.net.xml",
...
def run_simulation_scale(matched_df, duration=401, output_json_path="simulation_results\\rain_average_speeds_scale.json"):
