...
def run_simulation(matched_df, duration=401, output_json_path="E:\\Traffic_Simulation\\Adverse_weather_traffic\\simulation_results\\normal_average_speeds_0718.json"):
    print(matched_df)
    time_road_speeds = {}
