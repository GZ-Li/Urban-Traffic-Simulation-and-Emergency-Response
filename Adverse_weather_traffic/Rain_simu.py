...
# ==================== 配置部分 ====================
simulation_config = {
    "sumo_cfg": "E:\\Traffic_Simulation\\Adverse_weather_traffic\\Core_500m_test_rain.sumocfg",
    "original_route": "E:\\Traffic_Simulation\\Adverse_weather_traffic\\rou\\mapcore_500m_core_withshape_with_light_test.rou.xml",
    "rain_route": "E:\\Traffic_Simulation\\Adverse_weather_traffic\\rou\\mapcore_500m_core_withshape_with_light_test_rain.rou.xml",
...
def run_simulation_time(matched_df, duration=401, output_json_path="E:\\Traffic_Simulation\\Adverse_weather_traffic\\simulation_results\\rain_average_speeds_0720_test_time.json"):
    param_combinations = list(itertools.product(
        simulation_config["weather_params"]["accel"],
        simulation_config["weather_params"]["decel"],
        simulation_config["weather_params"]["max_speed"],
        simulation_config["weather_params"]["min_gap"]
    ))
    total_res = {}
    for param in param_combinations:
        print(param)
        modify_vehicle_xml(simulation_config["original_route"], simulation_config["rain_route"], param[0], param[1], param[2], param[3])
        init_sumo()
        time_road_speeds = {}
        ...
        total_res["_".join(param)] = time_road_speeds
        traci.close()
    with open(output_json_path, "w") as f:
        json.dump(total_res, f, indent=4)


def run_simulation_scale(matched_df, duration=401, output_json_path="E:\\Traffic_Simulation\\Adverse_weather_traffic\\simulation_results\\rain_average_speeds_0720_test_scale.json"):
    param_combinations = list(itertools.product(
        simulation_config["weather_params"]["accel"],
        simulation_config["weather_params"]["decel"],
        simulation_config["weather_params"]["max_speed"],
...
if __name__ == '__main__':
    ...
    # run_simulation_time(df)
    # run_simulation_scale(df)
    # modify_vehicle_xml("E:\\Traffic_Simulation\\Adverse_weather_traffic\\rou\\mapcore_500m_core_withshape_with_light_test.rou.xml", "E:\\Traffic_Simulation\\Adverse_weather_traffic\\rou\\mapcore_500m_core_withshape_with_light_test_normal.rou.xml", "2.6", "4.5", "35", "2.5")
    modify_vehicle_xml("E:\\Traffic_Simulation\\Adverse_weather_traffic\\scale_rou\\routes_od_4.rou.xml", "E:\\Traffic_Simulation\\Adverse_weather_traffic\\snowplow_rou\\routes_od_4_rain.rou.xml", "1.0", "2.0", "15", "5.0")