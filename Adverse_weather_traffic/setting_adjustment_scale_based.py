...
for param in param_combination:
    for time_ in time_intervals:
        ...
        param_time_accuracy[f"{param}_{time_}_{str(accuracy_1)}_{str(accuracy_2)}"] = accuracy_1
...
with open("simulation_results/param_time_accuracy_initial_0720_test_scale.json", "w") as f:
