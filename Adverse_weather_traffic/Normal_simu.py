...
simulation_config = {
    "sumo_cfg": "E:\\Traffic_Simulation\\Adverse_weather_traffic\\Core_500m_test.sumocfg",  # SUMO配置文件路径
...
if not os.path.exists(simulation_config['output_dir']):
    ...
    print(f"输出目录已存在: {simulation_config['output_dir']}")
...
def run_simulation_time(matched_df, duration=401, output_json_path="E:\\Traffic_Simulation\\Adverse_weather_traffic\\simulation_results\\normal_average_speeds_0720_test_time.json"):
    time_road_speeds = {}
...
def run_simulation_scale(matched_df, output_json_path="E:\\Traffic_Simulation\\Adverse_weather_traffic\\simulation_results\\normal_average_speeds_0720_test_scale.json"):
    time_road_speeds = {}
...
# net = readNet(simulation_config['net_path'])
# test_edge = net.getEdges()[0]
# test_edge_id = test_edge.getID()
# test_edge_coords = get_edge_coordinates(net, test_edge_id)
# print(test_edge_coords)
# road_df = load_road_data(simulation_config['road_data_csv'])
# road_coords = road_df['geometry'][0]
# print(road_coords)
# print(type(road_coords))
# print(string_to_linestring(road_coords))
# print(type(road_coords))
# print(is_road_matched(test_edge_coords, string_to_linestring(road_coords), 0.0002))
# df = match_edges_to_roads(net, road_df)
# print(df.shape)
# print(df)
# init_sumo()
