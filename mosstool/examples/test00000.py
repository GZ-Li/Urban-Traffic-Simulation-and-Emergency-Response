import sys
import os
sys.path.append("E:\\Traffic_Simulation\\mosstool")

from mosstool.trip.generator import (PositionMode, RandomGenerator, default_person_template_generator)
...
from mosstool.map._map_util.const import JUNC_START_ID
